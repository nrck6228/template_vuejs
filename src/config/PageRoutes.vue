...
//Create Route
import TableSearch from '../pages/Table-search.vue'
import FormInsulation from '../pages/Form-insulation.vue'

const routes = [
	{ path: '*', redirect: '/Table/search' },
  ...
  { path: '/Form/insulation', component: FormInsulation }
]
